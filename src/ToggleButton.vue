<template>
  <label :class="className">
    ...
    <template>
      <span class="v-switch-label v-left" :style="labelStyle">
        <slot name="checked">
          <template>{{labelChecked}}</template>
        </slot>
      </span>
      <span class="v-switch-label v-right" :style="labelStyle">
        <slot name="unchecked">
...
<script>
const DEFAULT_COLOR_CHECKED = "rgba(255, 255, 255, 0.5)";
const DEFAULT_COLOR_UNCHECKED = "rgba(255, 255, 255, 0.5)";
